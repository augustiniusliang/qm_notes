...
\include{chaps/evolution_symmetries}
\include{chaps/sols_pics_reps}
\include{chaps/ang_momentum}
\include{chaps/composite_entanglement}
\include{chaps/perturbation_scattering}
\include{chaps/path_int}
\include{chaps/sec_quant}

\appendix
\include{chaps/appendix_math}
\include{chaps/appendix_groups}
\include{chaps/appendix_units}
\include{chaps/appendix_probability}
